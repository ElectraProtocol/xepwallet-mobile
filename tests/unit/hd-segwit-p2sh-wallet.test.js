...
describe('P2SH Segwit HD (BIP49)', () => {
  it('can create a wallet', async () => {
    ...
    assert.strictEqual(hd._getDerivationPathByAddress(hd._getExternalAddressByIndex(0)), "m/49'/597'/0'/0/0");
    assert.strictEqual(hd._getDerivationPathByAddress(hd._getInternalAddressByIndex(0)), "m/49'/597'/0'/1/0");
